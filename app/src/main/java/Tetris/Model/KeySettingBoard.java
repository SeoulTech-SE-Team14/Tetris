...
public class KeySettingBoard extends Observable {
    ...
    // default image
    private final ImageIcon rightKeyImage = new ImageIcon("app/src/main/resources/image/KeySettingView/key_right.png");
    private final ImageIcon leftKeyImage = new ImageIcon("app/src/main/resources/image/KeySettingView/key_left.png");
    private final ImageIcon downKeyImage = new ImageIcon("app/src/main/resources/image/KeySettingView/key_down.png");
    private final ImageIcon fallKeyImage = new ImageIcon("app/src/main/resources/image/KeySettingView/key_fall.png");
    private final ImageIcon rotateKeyImage = new ImageIcon("app/src/main/resources/image/KeySettingView/key_rotate.png");
    private final ImageIcon pauseKeyImage = new ImageIcon("app/src/main/resources/image/KeySettingView/key_pause.png");
    private final ImageIcon storeBtnImage = new ImageIcon("app/src/main/resources/image/KeySettingView/button_store.png");
    private final ImageIcon backBtnImage = new ImageIcon("app/src/main/resources/image/KeySettingView/button_back.png");
    private final ImageIcon keyFieldImage = new ImageIcon("app/src/main/resources/image/KeySettingView/text_field.png");
    // focus image
    private final ImageIcon focusStoreBtnImage = new ImageIcon("app/src/main/resources/image/KeySettingView/button_store_focused.png");
    private final ImageIcon focusBackBtnImage = new ImageIcon("app/src/main/resources/image/KeySettingView/button_back_focused.png");
